...
1. **Correlation analysis:**
  ...
  - There is a strong positive correlation between the number of calls handled and the total call duration, indicating that as the number of calls increases, the total duration   also increases.
     
  - A moderate positive correlation was observed between wait time and total call duration, suggesting that when total call duration is longer, wait times also tend to increase.
